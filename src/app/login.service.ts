...
export class LoginService {
  ...
  client_id: string = 'ed736dc4cdb4429792e0aa5dce505893';
  client_secret: string = '4f7c368bd8044a15b864f72107da5612';
  scope: string = 'user-read-private user-read-email';
  redirect_uri:string = 'http://localhost:4200/dashboard';
 ...
 */
  ...
  // $.ajax = get('/login', function (req, res) {
  ...
  //   res.('https://accounts.spotify.com/authorize?' +
